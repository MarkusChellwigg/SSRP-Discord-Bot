...
public class Statistics : ModuleBase<SocketCommandContext>
{
    ...
    {
        if (PermissionManager.GetPerms(Context.Message.Author.Id) < PermissionConfig.SendStatistics) { await Context.Channel.SendMessageAsync("Not authorised to run this command."); return; }
